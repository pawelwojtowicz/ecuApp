...
qemu-system-arm -m 128 -M versatilepb -kernel $LINUX_IMG_PATH -initrd $ROOT_FILE_SYSTEM_IMAGE -nographic -append "console=ttyAMA0,115200 root=/dev/ram" -net nic -net user,hostfwd=tcp::8080-:80 
