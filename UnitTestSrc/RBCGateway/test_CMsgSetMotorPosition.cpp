...
#include <RBCGateway/CMsgSetMotorPosition.h>

#define TEST_BUFFER_SIZE 100

TEST( CMsgSetMotorPosition,BasicSize )
{	
	RBCGateway::CMsgSetMotorPosition msg;
...
TEST( CMsgSetMotorPosition, Content )
{	
	RBCGateway::CMsgSetMotorPosition msg;
	
	msg.SetAddress(RBCGateway::moduleStepping_1);
	msg.SetMotorID(0x0001);
	msg.SetPosition(0xF0FF);
	...
	EXPECT_EQ( testBuffer[2] 	, static_cast<Int8>(0x27 ));
